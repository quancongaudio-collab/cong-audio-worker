...
=== NHIỆM VỤ ===
Phân tích {frame_count} frame bên dưới và transcript. Trả về DUY NHẤT một JSON hợp lệ. Không markdown.
...
{{
  ...
  "scenes": [{{"start": "00:00", "end": "00:30", "description": "Mô tả cảnh."}}],
  ...
  "highlight_scenes": [{{"timestamp": "00:00-00:30", "reason": "Lý do đáng dùng lại."}}],
...
def save_scenes(conn, video_id: str, scenes: list, highlight_scenes: list):
    ...
    for i, scene in enumerate(scenes):
        ...
        rows.append((
            ...
            scene.get("start", ""), scene.get("end", ""),
            scene.get("description", ""), is_highlight, embedding,
        ))
    with conn.cursor() as cur:
        execute_values(cur, """
